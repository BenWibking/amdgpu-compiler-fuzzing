...
pass settings, runs `llc`, and relies on a GPU oracle plus optional
...
- Runs `llc -stop-after=<passes> -print-after=<passes>` to produce the final MIR.
